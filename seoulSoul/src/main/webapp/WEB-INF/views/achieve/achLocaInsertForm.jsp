...
<body>
    ...
    <div class="container">
        <div class="full-width">
            <form action="${pageContext.request.contextPath}/admin/achLocaInsertForm" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="singleFile"><strong>업적 아이콘 업로드 폼</strong></label>
                    <input type="file" id="singleFile" name="singleFile" onchange="previewImage(event)" required>
                </div>
                <div class="preview">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="maxCount" name="maxCount" value="${achLoca.maxCount}" required>
                </div>
                <div class="form-group">
                    <label for="title"><strong>타이틀 이름 입력 폼</strong></label>
                    <input type="text" id="title" name="title" value="${achLoca.title}" required>
                </div>
